...
public class WrappedPacketOutNamedSoundEffect extends WrappedPacket implements SendableWrapper {
    ...
    public WrappedPacketOutNamedSoundEffect(String soundEffectName,  SoundCategory soundCategory, Vector3d effectPosition, float volume, float pitch) {
    ...
    public WrappedPacketOutNamedSoundEffect(String soundEffectName,  SoundCategory soundCategory, double effectPositionX, double effectPositionY, double effectPositionZ, float volume, float pitch) {
        this.soundEffectName = soundEffectName;
        this.soundCategory = soundCategory;
